...
def create_cust():
    try:        
        ...
        if _name and _email and _phone and _address and request.method == 'POST':
            ...
            sqlQuery = "INSERT INTO customers (name, email, phone, address) VALUES(%s, %s, %s, %s)"
...
def cust_details(id):
    try:
        conn = mysql.connect()
        cursor = conn.cursor(pymysql.cursors.DictCursor)
        cursor.execute("SELECT id, name, email, phone, address FROM customers WHERE id =%s", emp_id)
